...
?>
<h4><i class="fa fa-inbox"></i><?='   '.Yii::t('message', 'Inbox')?></h4>
                ...
                'value' => function ($data) {
                    switch ($data->status) {
                        case Message::STATUS_UNREAD:
                            return '<span class="fa fa-envelope" title="' . Yii::t('message', 'unread') . '">';
                            break;
                        case Message::STATUS_READ:
                            return '<span class="fa fa-eye" title="' . Yii::t('message', 'read') . '">';
                            break;
                        case Message::STATUS_ANSWERED:
                            return '<span class="fa fa-check" title="' . Yii::t('message', 'answered') . '">';
                            break;
                    }
                },
            ],
