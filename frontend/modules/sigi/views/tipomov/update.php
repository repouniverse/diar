...
$this->title = Yii::t('sigi.labels', 'Update Sigi Tipomov: {name}', [
    'name' => $model->codigo,
]);
...
<h4><i class="fa fa-edit"></i><?= Html::encode($this->title) ?></h4>
    ...
    'items' => [
        ...
        [
          'label'=>'<i class="fa fa-users"></i> '.yii::t('sta.labels','Otros'), //$this->context->countDetail() obtiene el contador del detalle
