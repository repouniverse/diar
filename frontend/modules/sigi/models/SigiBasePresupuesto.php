...
class SigiBasePresupuesto extends \common\models\base\modelBase
{
   const SCENARIO_IMPORTACION='importacion';
     ...
     public function scenarios()
    {
        ...
        $scenarios[self::SCENARIO_REGULAR] = [
            'edificio_id','cargosedificio_id','codigo',/*'cargo_id','cargosgrupoedificio_id','cargosedificio_id',*/
            'descripcion','activo','ejercicio','anual','mensual'];
