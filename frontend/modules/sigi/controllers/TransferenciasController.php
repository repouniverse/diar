...
class TransferenciasController extends baseController
{
   ...
   public function actionPropietario(){
       if (h::request()->isAjax) {
           $valor=h::request()->post('unidad');
          $model= \frontend\modules\sigi\models\SigiUnidades::findOne($valor);
          $nombre=$model->currentPropietario()->nombre;
