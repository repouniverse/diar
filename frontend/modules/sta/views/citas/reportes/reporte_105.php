...
?>
<br>
<div class="titulo">INFORME DEL PERFIL PSICOLÓGICO (EPP)</div>
...
<div class="afiliacion">
 <?php
    ...
    $datos=$query->select(['puntaje_total','percentil','categoria','b.nombre','b.nemonico','b.nombre'])->join('INNER JOIN','{{%sta_testindicadores}} b','indicador_id=b.id')->asArray()->all();
...
<br>
<br>
<div class="subtitulo">III CONCLUSIONES DE LA EVALUACION</div>
<div class="afiliacion">
   <?=$model->getAttributeLabel('conclu_acad') ?>
</div>
...
<div class="subtitulo">V RECOMENDACIONES PARA EL TUTOR ACADEMICO</div>
<div class="afiliacion">
   <?=$model->getAttributeLabel('recom_tutor_acad') ?>
</div>
<div class="afiliacion italica">
